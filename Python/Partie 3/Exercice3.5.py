...
veut_acheter_snack = True
while veut_acheter_snack :
    ...
    print("Souhaitez-vous acheter un nouveau snack ?")
    veut_acheter_snack = (input() == "oui")
#ou
    print("Souhaitez-vous faire un nouvel achat ? (1 pour oui, 0 pour non)")
    veut_acheter_snack = bool(int(input()))